...
xbps-install -y xfce4 xfce4-plugins lightdm lightdm-gtk3-greeter dbus xfce4-pulseaudio-plugin xfce4-screenshooter thunar-archive-plugin unzip xarchiver exfat-utils udiskie ufw gufw xdg-user-dirs-gtk gvfs thunar-volman
...
xbps-install -y fcitx5 fcitx5-gtk fcitx5-gtk+3 fcitx5-gtk4 fcitx5-qt fcitx5-configtool fcitx5-mozc
